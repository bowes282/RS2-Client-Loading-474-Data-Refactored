...
public class GameShell extends Applet implements Runnable, MouseListener, MouseMotionListener, MouseWheelListener, KeyListener, FocusListener, WindowListener {
	...
	final void createClientFrame(int w, int h) {
		...
		myWidth = w;
		myHeight = h;
		gameFrame = new GameFrame(this, myWidth, myHeight, Game.frameMode == Game.ScreenMode.RESIZABLE, Game.frameMode == Game.ScreenMode.FULLSCREEN);
    ...
    public void mouseWheelMoved(MouseWheelEvent event) {
		...
		if(mouseX > 0 && mouseX < 512 && mouseY > Game.frameHeight - 165 && mouseY < Game.frameHeight - 25) {
    ...
    void drawLoadingText(int percentage, String loadingText) {
		...
		graphics.setColor(Color.black);
		graphics.fillRect((Game.frameWidth / 2 - 150) + percentage * 3, y + 2, 300 - percentage * 3, 30);
		graphics.setFont(font);
		graphics.setColor(Color.white);
		graphics.drawString(loadingText,(Game.frameWidth - fontmetrics.stringWidth(loadingText)) / 2, y + 22);
		graphics.drawString("", (Game.frameWidth - fontmetrics1.stringWidth("")) / 2, y - 8);
	}

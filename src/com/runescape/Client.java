...
public class Client extends GameApplet {
      ...
      public void updateEntities() {
            try {
                  ...
                  for (int j = -1; j < playerCount + npcCount; j++) {
                        ...
                        if (((Entity) (obj)).spokenText != null && (j >= playerCount
                              ...
                              if (spriteDrawX > -1 && messageLength < anInt975) {
                                    anIntArray979[messageLength] =
                                                boldText.method384(((Entity) (obj)).spokenText) / 2;
                              ...
                              for (int j2 = 0; j2 < 4; j2++) {
                                    if (((Entity) (obj)).hitsLoopCycle[j2] > loopCycle) {
                                          npcScreenPos(((Entity) (obj)),
                                                      ((Entity) (obj)).height / 2);
                                          if (spriteDrawX > -1) {
                                                if (j2 == 0 && ((Entity) (obj)).hitDamages[j2] > 99)
      ...
      private void showOtherPlayers(boolean flag) {
            ...
            for (int l = 0; l < j; l++) {
                  ...
                  if (player.aModel_1714 != null && loopCycle >= player.anInt1707
                        ...
                        scene.method286(plane, player.y, player, player.anInt1552, player.anInt1722,
                  ...
                  player.anInt1709 = method42(plane, player.y, player.x);
                  scene.method285(plane, player.anInt1552, player.anInt1709, i1, player.y, 60,
            ...
            if (k1 != 0) {
                  ...
                  if (class46.mapscene != -1) {
                        ...
                        if (background != null) {
                              ...
                              background.drawBackground(48 + l * 4 + i4,
            ...
            if (j == 0) {
                  ...
                  for (int l = 0; l < 12; l++)
                        aBackgroundArray1152s[l] =
                                    new Background(titleStreamLoader, "runes", 12 + (l & 3));
      ...
      private CacheArchive createArchive(int file, String displayedName, String name,
                        ...
                        try {
                              if (npc.desc.boundDim == 1 && (npc.x & 0x7f) == 64
                                    ...
                                    for (int j2 = 0; j2 < npcCount; j2++) {
                                          ...
                                          if (npc2 != null && npc2 != npc && npc2.desc.boundDim == 1
                                    ...
                                    for (int l2 = 0; l2 < playerCount; l2++) {
                                          ...
                                          if (player != null && player.x == npc.x
                                                      && player.y == npc.y)
                                                buildAtPlayerMenu(i1, playerIndices[l2], player,
                                                            j1);
                                    }
                              }
                        ...
                        if ((j == 13 || j == 10) && inputString.length() > 0) {
                              if (myPrivilege == 2 || server.equals("127.0.0.1")) {
                                    ...
                                    if (inputString.equals("::rint")) {
                                          ...
                                          CacheArchive interfaces = createArchive(3, "interface",
                                                      "interface", archiveCRCs[3], 35);
                                          CacheArchive graphics = createArchive(4, "2d graphics",
      ...
      void startUp() {
            ...
            try {
                  ...
                  CacheArchive streamLoader =
                              createArchive(2, "config", "config", archiveCRCs[2], 30);
                  CacheArchive streamLoader_1 =
                              createArchive(3, "interface", "interface", archiveCRCs[3], 35);
                  CacheArchive streamLoader_2 =
                              createArchive(4, "2d graphics", "media", archiveCRCs[4], 40);
                  this.mediaStreamLoader = streamLoader_2;
                  CacheArchive streamLoader_3 =
                              createArchive(6, "textures", "textures", archiveCRCs[6], 45);
                  CacheArchive streamLoader_4 =
                              createArchive(7, "chat system", "wordenc", archiveCRCs[7], 50);
      ...
      private void entityUpdateBlock(Entity entity) {
            ...
            if (entity == localPlayer && (entity.x < 1536 || entity.y < 1536 || entity.x >= 11776
                        || entity.y >= 11776)) {
                  entity.emoteAnimation = -1;
                  entity.gfxId = -1;
                  entity.startForceMovement = 0;
      ...
      private void refreshEntityFaceDirection(Entity entity) {
            if (entity.endForceMovement == loopCycle || entity.emoteAnimation == -1
                        || entity.animationDelay != 0
                        || entity.emoteTimeRemaining
                                    + 1 > Animation.animations[entity.emoteAnimation]
      ...
      private void getDegreesToTurn(Entity entity) {
            ...
            int i = entity.x;
            int j = entity.y;
            int k = entity.pathX[entity.smallXYIndex - 1] * 128 + entity.boundDim * 64;
            int l = entity.pathY[entity.smallXYIndex - 1] * 128 + entity.boundDim * 64;
                  ...
                  if (childInterface.type == Widget.TYPE_CONTAINER) {
                        ...
                        if (childInterface.scrollMax > childInterface.height)
                              drawScrollbar(childInterface.height, childInterface.scrollPosition,
                                          _y, _x + childInterface.width, childInterface.scrollMax,
                                          false);
                        ...
                        if (childInterface.type == Widget.TYPE_INVENTORY) {
                              ...
                              if (childInterface.opacity == 0) {
                                    if (childInterface.filled)
                                          Raster.drawPixels(childInterface.height, _y, _x, colour,
                                                      childInterface.width);
                                    else
                              ...
                              for (int l6 = _y + textDrawingArea.anInt1497; text.length() > 0; l6 +=
                                    ...
                                    if (childInterface.centerText) {
                                          font.drawCenteredString(s1, _x + childInterface.width / 2,
                                                      l6, colour,
                              ...
                              for (int j11 = yPos + font.anInt1497 + 2; s2.length() > 0; j11 +=
                                          font.anInt1497 + 1) {// anInt1497
                                    if (s2.indexOf("%") != -1) {
                                          do {
                                                int k7 = s2.indexOf("%1");
                                                if (k7 == -1)
      ...
      private void parseRegionPackets(Buffer stream, int j) {
            ...
            if (j == 4) {
                  ...
                  if (i5 >= 0 && l7 >= 0 && i5 < 104 && l7 < 104) {
                        i5 = i5 * 128 + 64;
                        l7 = l7 * 128 + 64;
                        AnimableObject class30_sub2_sub4_sub3 = new AnimableObject(plane, loopCycle,
